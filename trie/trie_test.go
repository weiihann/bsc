...
// Used for testing
func newEmpty() *Trie {
	trie, _ := New(common.Hash{}, NewDatabase(memorydb.New()), 0)
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	trie, err := New(common.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), NewDatabase(memorydb.New()), 0)
	if trie != nil {
...
func testMissingNode(t *testing.T, memonly bool) {
	...
	trie, _ := New(common.Hash{}, triedb, 0)
...
func runRandTest(rt randTest) bool {
	...
	for i, step := range rt {
		...
		case opItercheckhash:
			checktr, _ := New(common.Hash{}, triedb, 0)
...
func TestTinyTrie(t *testing.T) {
	...
	checktr, _ := New(common.Hash{}, trie.db, 0)
