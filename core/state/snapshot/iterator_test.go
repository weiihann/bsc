...
func TestAccountIteratorBasics(t *testing.T) {
	...
	diffLayer := newDiffLayer(emptyLayer(), common.Hash{}, 0, copyDestructs(destructs), copyAccounts(accounts), copyStorage(storage), nil)
...
func TestStorageIteratorBasics(t *testing.T) {
	...
	// Add some (identical) layers on top
	diffLayer := newDiffLayer(emptyLayer(), common.Hash{}, 0, nil, copyAccounts(accounts), copyStorage(storage), nil)
...
func TestAccountIteratorTraversal(t *testing.T) {
	...
	snaps.update(common.HexToHash("0x02"), 0, common.HexToHash("0x01"), nil,
		randomAccountSet("0xaa", "0xee", "0xff", "0xf0"), nil, nil)

	snaps.update(common.HexToHash("0x03"), 0, common.HexToHash("0x02"), nil,
		randomAccountSet("0xbb", "0xdd", "0xf0"), nil, nil)

	snaps.update(common.HexToHash("0x04"), 0, common.HexToHash("0x03"), nil,
...
func TestAccountIteratorTraversalValues(t *testing.T) {
	...
	snaps.update(common.HexToHash("0x02"), 0, common.HexToHash("0x01"), nil, a, nil, nil)
	snaps.update(common.HexToHash("0x03"), 0, common.HexToHash("0x02"), nil, b, nil, nil)
	snaps.update(common.HexToHash("0x04"), 0, common.HexToHash("0x03"), nil, c, nil, nil)
	snaps.update(common.HexToHash("0x05"), 0, common.HexToHash("0x04"), nil, d, nil, nil)
	snaps.update(common.HexToHash("0x06"), 0, common.HexToHash("0x05"), nil, e, nil, nil)
	snaps.update(common.HexToHash("0x07"), 0, common.HexToHash("0x06"), nil, f, nil, nil)
	snaps.update(common.HexToHash("0x08"), 0, common.HexToHash("0x07"), nil, g, nil, nil)
	snaps.update(common.HexToHash("0x09"), 0, common.HexToHash("0x08"), nil, h, nil, nil)
...
func TestStorageIteratorTraversalValues(t *testing.T) {
	...
	// Assemble a stack of snapshots from the account layers
	snaps.update(common.HexToHash("0x02"), 0, common.HexToHash("0x01"), nil, randomAccountSet("0xaa"), wrapStorage(a), nil)
	snaps.update(common.HexToHash("0x03"), 0, common.HexToHash("0x02"), nil, randomAccountSet("0xaa"), wrapStorage(b), nil)
	snaps.update(common.HexToHash("0x04"), 0, common.HexToHash("0x03"), nil, randomAccountSet("0xaa"), wrapStorage(c), nil)
	snaps.update(common.HexToHash("0x05"), 0, common.HexToHash("0x04"), nil, randomAccountSet("0xaa"), wrapStorage(d), nil)
	snaps.update(common.HexToHash("0x06"), 0, common.HexToHash("0x05"), nil, randomAccountSet("0xaa"), wrapStorage(e), nil)
	snaps.update(common.HexToHash("0x07"), 0, common.HexToHash("0x06"), nil, randomAccountSet("0xaa"), wrapStorage(e), nil)
	snaps.update(common.HexToHash("0x08"), 0, common.HexToHash("0x07"), nil, randomAccountSet("0xaa"), wrapStorage(g), nil)
	snaps.update(common.HexToHash("0x09"), 0, common.HexToHash("0x08"), nil, randomAccountSet("0xaa"), wrapStorage(h), nil)
...
func TestAccountIteratorLargeTraversal(t *testing.T) {
	...
	for i := 1; i < 128; i++ {
		snaps.update(common.HexToHash(fmt.Sprintf("0x%02x", i+1)), 0, common.HexToHash(fmt.Sprintf("0x%02x", i)), nil, makeAccounts(200), nil, nil)
	}
...
func TestAccountIteratorDeletions(t *testing.T) {
	...
	// Stack three diff layers on top with various overlaps
	snaps.update(common.HexToHash("0x02"), 0, common.HexToHash("0x01"),
	...
	snaps.update(common.HexToHash("0x03"), 0, common.HexToHash("0x02"),
		destructed, randomAccountSet("0x11", "0x33"), nil, nil)

	snaps.update(common.HexToHash("0x04"), 0, common.HexToHash("0x03"),
...
func TestStorageIteratorDeletions(t *testing.T) {
	...
	snaps.update(common.HexToHash("0x04"), 0, common.HexToHash("0x03"), destructed, nil, nil, nil)
	...
	snaps.update(common.HexToHash("0x05"), 0, common.HexToHash("0x04"), nil,
	...
	snaps.update(common.HexToHash("0x06"), 0, common.HexToHash("0x05"), destructed, randomAccountSet("0xaa"), randomStorageSet([]string{"0xaa"}, [][]string{{"0x11", "0x12"}}, nil), nil)
...
func BenchmarkAccountIteratorLargeBaselayer(b *testing.B) {
	...
	snaps.update(common.HexToHash("0x02"), 0, common.HexToHash("0x01"), nil, makeAccounts(2000), nil, nil)
	for i := 2; i <= 100; i++ {
		snaps.update(common.HexToHash(fmt.Sprintf("0x%02x", i+1)), 0, common.HexToHash(fmt.Sprintf("0x%02x", i)), nil, makeAccounts(20), nil, nil)
	}
	// We call this once before the benchmark, so the creation of
	// sorted accountlists are not included in the results.
	head := snaps.Snapshot(common.HexToHash("0x65"))
