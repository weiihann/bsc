...
// copying everything.
func (dl *diskLayer) Update(blockHash common.Hash, destructs map[common.Hash]struct{}, accounts map[common.Hash][]byte, storage map[common.Hash]map[common.Hash][]byte, verified chan struct{}, blockNum uint64) *diffLayer {
	return newDiffLayer(dl, blockHash, destructs, accounts, storage, verified, blockNum)
}
